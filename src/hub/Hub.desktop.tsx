...
export function HubDesktop({ content }: Props) {
  ...
  return (
    <div className="h-screen bg-transparent flex flex-col antialiased overflow-hidden relative">
      ...
      <header className="px-12 pt-8 pb-4 flex items-center justify-between relative z-10">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <span className="mono-label !opacity-100 text-amber-600 dark:text-amber-500">OPERATIVE_HUD</span>
            <span className="text-[10px] text-theme-muted font-mono tracking-tighter">SEC_LVL_04 // [DATAREADY]</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-8">
           <div className="flex flex-col items-end">
             ...
             <span className="text-xs font-mono text-theme-secondary">{new Date().toLocaleTimeString()}</span>
           </div>
        </div>
      </header>
      ...
      >
        {/* Module 1: Profile & Hero (Large Bento) - REDUCED SIZE */}
        <div className="col-span-8 row-span-3 glass-premium p-10 flex flex-col justify-between relative overflow-hidden group hover:border-amber-500/30 transition-colors">
          ...
          <div className="flex items-start justify-between gap-12">
            <div className="space-y-4 flex-1">
              ...
              <EditableText id="hub.ownerName" value={content.ownerName} as="h1" className="text-7xl font-black text-theme-primary tracking-tight" />
              {content.ownerQuote && (
                <div className="max-w-[500px] border-l-2 border-amber-500/20 pl-6 mt-8">
                  <EditableText id="hub.ownerQuote" value={content.ownerQuote} as="p" className="text-lg text-theme-secondary font-serif italic leading-relaxed" />
                </div>
              )}
            </div>
            ...
            <ImageUpload 
              ...
              className="w-48 h-48 rounded-[2rem] bg-theme-base/20 shrink-0 shadow-2xl relative overflow-hidden group/img p-1 border border-theme-default/20"
            >
          ...
          <div className="flex items-center gap-6 mt-12 pb-2">
             <div className="flex-1 h-[1px] bg-theme-default" />
             <div className="flex gap-4">
                <div className="w-2 h-2 bg-amber-500/40 rounded-full" />
                <div className="w-2 h-2 bg-theme-muted/20 rounded-full" />
                <div className="w-2 h-2 bg-theme-muted/20 rounded-full" />
             </div>
          </div>
        </div>
        ...
        <aside className="col-span-4 row-span-6 glass-premium p-8 flex flex-col gap-8 relative overflow-hidden hover:border-amber-500/20 transition-colors">
          ...
          <motion.button
            ...
            className="w-full py-4 glass-premium text-[10px] font-mono text-theme-secondary hover:text-amber-600 dark:hover:text-amber-500 hover:border-amber-500 transition-all duration-300 uppercase tracking-widest flex items-center justify-center gap-3 group"
          >
        ...
        {/* Module 3: System Access / Quick Access (Horizontal Base) - INCREASED SIZE */}
        <div className="col-span-8 row-span-3 glass-premium p-8 flex flex-col gap-6 relative overflow-hidden group">
