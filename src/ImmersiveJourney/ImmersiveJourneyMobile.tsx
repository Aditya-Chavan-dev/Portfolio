...
export const ImmersiveJourneyMobile: React.FC<ImmersiveJourneyMobileProps> = ({ onBack }) => {
    return (
        <div className="fixed inset-0 z-[100] bg-obsidian text-primary flex-center p-6 text-center">
            <div className="animate-fade-in flex flex-col items-center">
                ...
                <button
                    onClick={onBack}
                    className="px-6 py-3 bg-white/5 border-white-10 rounded-sm text-xs font-mono tracking-widest uppercase active:bg-gold-glow/20 transition-all"
                >
                    Return to Base
                </button>
            </div>
