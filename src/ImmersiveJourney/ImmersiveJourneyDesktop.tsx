...
export const ImmersiveJourneyDesktop: React.FC<ImmersiveJourneyDesktopProps> = ({ onBack }) => {
    return (
        <div className="fixed inset-0 z-overlay bg-obsidian text-primary flex-center">
            <div className="text-center animate-fade-in flex flex-col items-center">
                ...
                <button
                    onClick={onBack}
                    className="group px-8 py-3 bg-transparent border-white-10 hover:border-gold-glow rounded-sm text-xs font-mono tracking-widest uppercase transition-fast"
                >
