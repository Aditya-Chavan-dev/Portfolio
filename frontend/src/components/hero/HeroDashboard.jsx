...
const TechIcons = {
    // Web Core
    "JavaScript": (
        <svg viewBox="0 0 24 24" fill="none" className="w-3 h-3 text-[#F7DF1E]"><path d="M4 4h16v16H4V4z" fill="currentColor" fillOpacity="0.1" /><path d="M7 17v-4c0-.55.45-1 1-1h1" stroke="currentColor" strokeWidth="1.5" /><path d="M14 17v-1.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5V17" stroke="currentColor" strokeWidth="1.5" /></svg>
    ),
    "TypeScript": (
        <svg viewBox="0 0 24 24" fill="none" className="w-3 h-3 text-[#3178C6]"><path d="M4 4h16v16H4V4z" fill="currentColor" fillOpacity="0.1" /><path d="M8 12h3m-1.5 0v5" stroke="currentColor" strokeWidth="1.5" /><path d="M17 14c-.5-.5-1.5-.5-2 0s-.5 1.5 0 2 2 .5 2 2-.5 2.5-2 2" stroke="currentColor" strokeWidth="1.5" /></svg>
    ),
    "HTML": (
        <svg viewBox="0 0 24 24" fill="none" className="w-3 h-3 text-[#E34F26]"><path d="M4 3l1.5 14L12 21l6.5-4L20 3H4z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" /></svg>
    ),
    "CSS": (
        <svg viewBox="0 0 24 24" fill="none" className="w-3 h-3 text-[#1572B6]"><path d="M4 3l1.5 14L12 21l6.5-4L20 3H4z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" /></svg>
    ),
    // Backend/Languages
    "Python": (
        <svg viewBox="0 0 24 24" fill="none" className="w-3 h-3 text-[#3776AB]"><path d="M12 9V5a3 3 0 00-3-3H4" stroke="currentColor" strokeWidth="1.5" /><path d="M12 15v4a3 3 0 003 3h5" stroke="currentColor" strokeWidth="1.5" /><circle cx="9" cy="9" r="1" fill="currentColor" /><circle cx="15" cy="15" r="1" fill="currentColor" /></svg>
    ),
    "Java": (
        <svg viewBox="0 0 24 24" fill="none" className="w-3 h-3 text-[#007396]"><path d="M4 19c2 2 8 2 16 0M4 14c2 2 8 2 16 0" stroke="currentColor" strokeWidth="1.5" /></svg>
    ),
    "C++": (
        <svg viewBox="0 0 24 24" fill="none" className="w-3 h-3 text-[#00599C]"><path d="M6 12h4m-2-2v4" stroke="currentColor" strokeWidth="1.5" /><path d="M14 10l2-2 2 2m-4 4l2 2 2-2" stroke="currentColor" strokeWidth="1.5" /></svg>
    ),
    "Shell": (
        <svg viewBox="0 0 24 24" fill="none" className="w-3 h-3 text-[#4EAA25]"><path d="M4 6l4 6-4 6m8-2h8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
    ),
    // Generic Code fallback
    "Code": (
        <svg viewBox="0 0 24 24" fill="none" className="w-3 h-3 text-gray-400"><path d="M8 12H4m16 0h-4M10 7l2 10" stroke="currentColor" strokeWidth="1.5" /></svg>
    ),
    // Specifics requested before (keeping them)
    "React 18": (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 text-[#61DAFB]"><path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor" strokeWidth="1.5" opacity="0.2" /><circle cx="12" cy="12" r="2" fill="currentColor" /><ellipse cx="12" cy="12" rx="10" ry="4" stroke="currentColor" strokeWidth="1.5" transform="rotate(60 12 12)" /><ellipse cx="12" cy="12" rx="10" ry="4" stroke="currentColor" strokeWidth="1.5" transform="rotate(120 12 12)" /><ellipse cx="12" cy="12" rx="10" ry="4" stroke="currentColor" strokeWidth="1.5" /></svg>
    ),
    "Node.js": (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 text-[#339933]"><path d="M12 2L2 7V17L12 22L22 17V7L12 2Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" /><path d="M12 22V12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /><path d="M12 12L2 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /><path d="M12 12L22 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /></svg>
    ),
    "Postgres": (
