                    ...
                    >
                        <div className="mt-5 flex flex-col gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-gray-300 text-[19px] leading-relaxed pl-1">
                                    {what}
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400 text-[19px] leading-relaxed pl-1">
                                        {tech}
                                    </p>
                                </div>
                            ...
                            {tip && (
                                <div className="mt-3">
                                    <div className="flex items-start gap-4">
                                        <div className="mt-0.5 text-yellow-500/80 text-[22px]">💡</div>
                                        <div className="flex-1">
                                            <span className="text-yellow-500/50 text-xs uppercase font-mono tracking-widest block mb-1.5">
                                                War Story
                                            </span>
                                            <p className="text-yellow-100/90 text-[19px] font-light italic leading-relaxed">
                                                {tip}
                                            </p>
                                        </div>
                                    </div>
